...
#[derive(Serialize, Deserialize, Clone, Debug)]
#[serde(default)]
pub struct Windows { pub file_viewer: WinState, pub inspector: WinState, pub console: WinState, pub recycler: WinState, pub mandelbrot: WinState, pub shell: WinState, pub concurrence: WinState }
