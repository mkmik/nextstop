...
- Scrollers (Console, Inspector, Recycler, Shell) sit on the **left** of their view, 21 px wide, laid out pixel for pixel like the 1.0 Librarian scroller: dark+black frame on top/left, one track pixel, 15 px knob and arrow faces with their black shadow, a light and a black edge on the right; 50 % dithered track, the round 6×6 dimple, both arrows stacked at the bottom.
