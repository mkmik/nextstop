...
pub enum WinKind { FileViewer, Inspector, Console, Info, Recycler, Mandelbrot, Shell, Alert }
...
pub enum Act {
    ...
    ViewBrowser, Scale1, Scale15, Scale2, ShowHidden, Backdrop, ShowDock, ShowMiniwindows, ShowRecycler, Inspector, ConsoleWin, Mandelbrot, ShellWin, FileViewerWin, RecyclerWin, ArrangeFront, Miniaturize, CloseWin, Hide, Quit,
}
...
pub static TOOLS_MENU: [ItemDef; 6] = [item("Inspector…", Some('i'), Act::Inspector), item("Finder…", None, Act::Disabled), item("Processes…", None, Act::Disabled), item("Console…", None, Act::ConsoleWin), item("Shell…", Some('t'), Act::ShellWin), item("Mandelbrot…", None, Act::Mandelbrot)];
